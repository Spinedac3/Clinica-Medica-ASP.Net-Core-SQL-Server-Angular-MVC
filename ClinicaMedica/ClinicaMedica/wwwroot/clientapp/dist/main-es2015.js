...
CitasDetailComponent.ctorParameters = () => [
...
CrearPacienteComponent.ctorParameters = () => [
    { type: ClientApp_app_shared_expediente_service__WEBPACK_IMPORTED_MODULE_3__["ExpedienteService"] },
...
DatosGeneralesComponent.ctorParameters = () => [
    { type: _shared_expediente_service__WEBPACK_IMPORTED_MODULE_2__["ExpedienteService"] }
];
...
PacienteDetailComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: ClientApp_app_shared_expediente_service__WEBPACK_IMPORTED_MODULE_3__["ExpedienteService"] }
];
...
CrearEvolucionComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _shared_expediente_service__WEBPACK_IMPORTED_MODULE_3__["ExpedienteService"] }
];
...
EvolucionDetalleComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: ClientApp_app_shared_expediente_service__WEBPACK_IMPORTED_MODULE_3__["ExpedienteService"] }
];
...
EvolucionComponent.ctorParameters = () => [
    { type: _shared_expediente_service__WEBPACK_IMPORTED_MODULE_2__["ExpedienteService"] }
];
...
CrearLaboComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _shared_expediente_service__WEBPACK_IMPORTED_MODULE_3__["ExpedienteService"] }
];
...
LaboratorioDetailComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: ClientApp_app_shared_expediente_service__WEBPACK_IMPORTED_MODULE_3__["ExpedienteService"] }
];
...
LaboratoriosComponent.ctorParameters = () => [
    { type: _shared_expediente_service__WEBPACK_IMPORTED_MODULE_2__["ExpedienteService"] }
];
...
CrearNotaComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
NotaDetailComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: ClientApp_app_shared_expediente_service__WEBPACK_IMPORTED_MODULE_3__["ExpedienteService"] }
];
...
NotasEnfermeraComponent.ctorParameters = () => [
    { type: _shared_expediente_service__WEBPACK_IMPORTED_MODULE_2__["ExpedienteService"] }
];
...
OrdenDetailComponent.ctorParameters = () => [
...
let ExpedienteService = class ExpedienteService {
    ...
    getPacientes() {
        return this.http.get(this.pacientesUrl, {
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(data => console.log('All: ' + JSON.stringify(data), this.paciente = data, console.log(this.paciente))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    getPaciente(id) {
        return this.getPacientes()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((paciente) => paciente.find(p => p.id === id)));
    }
    getDoctor(id) {
    ...
    getCita(id) {
        return this.getCitas()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((cita) => cita.find(p => p.id === id)));
    }
    getNotas() {
    ...
    getNota(id) {
        return this.getNotas()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((nota) => nota.find(p => p.id === id)));
    }
    getOrdenes() {
    ...
    getOrden(id) {
        return this.getOrdenes()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((orden) => orden.find(p => p.id === id)));
    }
    getLaboratorios() {
    ...
    getLaboratorio(id) {
        return this.getLaboratorios()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((laboratorio) => laboratorio.find(p => p.id === id)));
    }
    getEvoluciones() {
    ...
    getEvolucion(id) {
        return this.getEvoluciones()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((evolucion) => evolucion.find(p => p.id === id)));
    }
    get loginRequired() {
