...
namespace ClinicaMedica.Controllers
{
    ...
    public class LaboratorioController : Controller
    {
        ...
        private readonly ILogger<LaboratorioController> logger;
        private readonly UserManager<User> userManager;

        public LaboratorioController(IClinicaRepositorio clinicaRepositorio,
            ILogger<LaboratorioController> logger,
        ...
        public IActionResult Get()
        {
            try
            {
                return Ok(clinicaRepositorio.GetAllLaboratorios());
            }
            catch (Exception ex)
            {
